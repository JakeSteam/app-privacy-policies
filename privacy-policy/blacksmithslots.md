...
This privacy policy applies to the Blacksmith Slots app (hereby referred to as "Application") for mobile devices that was created by Jake Lee Ltd (hereby referred to as "Service Provider") as an Ad Supported service. This service is intended for use "AS IS".
