...
This privacy policy applies to the Pixel Blacksmith app (hereby referred to as "Application") for mobile devices that was created by Jake Lee Ltd (hereby referred to as "Service Provider") as a Freemium service. This service is intended for use "AS IS".
